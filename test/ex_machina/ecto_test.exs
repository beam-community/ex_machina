defmodule ExMachina.EctoTest do
  ...
  test "params_for/2 accept Ecto struct" do
    user_params = TestFactory.build(:user) |> TestFactory.params_for()
  ...
  test "string_params_for/2 accept Ecto struct" do
    user_params = TestFactory.build(:user) |> TestFactory.string_params_for()
